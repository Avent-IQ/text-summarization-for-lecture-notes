# Text-to-Text Transfer Transformer Quantized Model for Lecture Notes Summarization
...
- **Task:** Lecture Notes Summarization  
...
model_name = "AventIQ-AI/text-summarization-for-lecture-notes"
